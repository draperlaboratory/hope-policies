...
local_policies = sorted(["cfi", "rwx", "stack", "taint", "heap", "threeClass", "none", "userType", "testgenInfoLeak", "testgenMallocFailed", "testgenUninit", "testgenPtrArity","testgenVarArgsInit"])
