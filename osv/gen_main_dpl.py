...
local_policies = sorted(["cfi", "rwx", "stack", "taint", "heap", "threeClass", "none", "testSimple", "testComplex", "password", "ppac", "userType", "testContext", "testgenInfoLeak", "testgenMallocFailed", "testgenUninit", "testgenPtrArity"])
