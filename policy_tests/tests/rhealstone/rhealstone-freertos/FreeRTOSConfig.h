...
// RISC-V Specific Configuration _____________________________________
#define configCLINT_BASE_ADDRESS                CLINT_CTRL_ADDR

// General Configurations ____________________________________________
// Set preemption from the makefile
#ifdef BENCH_DISABLE_PREEMPTION
...
// Debug Support
#define configEXCEPTION_HANDLER_STACK_DUMP 1
#define configEXCEPTION_HANDLER_REGISTER_DUMP 1
