...
RHEAL_INTERTASK_TARGET   = $(OUTPUT_DIR)/rhealstone_intertask
RHEAL_INTERTASK_SRC      = $(RHEAL_SRC_DIR)/main_intertask_latency.c
RHEAL_INTERTASK_OBJ      =  $(patsubst %.c,%.o,$(RHEAL_INTERTASK_SRC))

.PHONY: clean-rhealstone clean-libfreertos clean-all build-libfreertos
all: $(RHEAL_INTERTASK_TARGET)

# Binary Targets _______________________________________________________________
$(RHEAL_INTERTASK_TARGET): $(ISP_OBJECTS) $(ISP_DEPS) $(ISP_LIBFREERTOS_NO_PREEMPT) $(COMMON_RHEAL_OBJS) $(RHEAL_INTERTASK_OBJ)
	$(CC) $(LDFLAGS) $(CFLAGS) $(INCLUDES) $(ISP_LIB_INCS) $(ISP_LIB_FLAGS) $(ISP_OBJECTS) \
	$(COMMON_RHEAL_OBJS) $(RHEAL_INTERTASK_OBJ) -o $@

# Object Targets  ______________________________________________________________
$(COMMON_RHEAL_OBJS): %.o: %.c $(COMMON_RHEAL_SRCS)
	$(CC) $(CFLAGS) $(INCLUDES) $< -c -o $@

$(RHEAL_INTERTASK_OBJ): $(RHEAL_INTERTASK_SRC)
