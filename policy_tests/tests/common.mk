...
$(TARGET): $(ISP_OBJECTS) $(ISP_LIBS) $(ISP_DEPS) $(OBJECTS) $(TEST_ASM_OBJECTS)
	$(CC) $(CFLAGS) $(INCLUDES) $(ISP_OBJECTS) $(OBJECTS) $(TEST_ASM_OBJECTS) -o $@ $(LDFLAGS)

$(OBJECTS): %.o: %.c $(SOURCES)
	$(CC) $(CFLAGS) $(INCLUDES) $< -c -o $@

$(TEST_ASM_OBJECTS): %.o: %.S $(TEST_ASM_SOURCES)
	$(CC) $(CFLAGS) $(INCLUDES) $< -c -o $@