...
def add_runtime(runtime, dp, template_dir, src_dir):
    ...
    if "frtos" in runtime:
        ...
        shutil.copyfile(os.path.join(template_dir, "test.cmakefile"), os.path.join(dp, "Makefile"))
    elif "hifive" in runtime:
        ...
        shutil.copyfile(os.path.join(template_dir, "test.makefile"), os.path.join(dp, "Makefile"))
    else:
